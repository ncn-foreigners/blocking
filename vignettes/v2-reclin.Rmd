...
It seems that the default parameters of the NND method result in an FNR of `r sprintf("%.4f",result2$metrics["fnr"]*100)`%. We can see if decreasing the `epsilon` parameter as suggested in the [Nearest Neighbor Descent
...
Changing the `epsilon` search parameter from 0.1 to 0.2 decreased the FNR to `r sprintf("%.4f",result3$metrics["fnr"]*100)`%.
...
It seems that the HNSW algorithm performed slightly better with `r sprintf("%.4f",result4$metrics["fnr"]*100)`% FNR. 
